...
define('students-records/components/student-data-entry', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Component.extend({
    ...
    updateAdanceStanding: function updateAdanceStanding() {
      var self = this;
    ...
    actions: {
      ...
      setCurrentAdvanceStanding: function setCurrentAdvanceStanding(advancestanding) {
        this.set('advanceStandingEditing', advancestanding);
      },

      editAdvanceStandingUnits: function editAdvanceStandingUnits(advanceStandingUnits) {
        var updatedAdvanceStanding = this.get('advanceStandingEditing');
        updatedAdvanceStanding.set('units', advanceStandingUnits);

        updatedAdvanceStanding.save().then(function () {});
      },

      editAdvanceStandingGrade: function editAdvanceStandingGrade(advanceStandingGrade) {
        var updatedAdvanceStanding = this.get('advanceStandingEditing');
      ...
      editAdvanceStandingFrom: function editAdvanceStandingFrom(advanceStandingFrom) {
        var updatedAdvanceStanding = this.get('advanceStandingEditing');
      ...
      editAdvanceStandingCourse: function editAdvanceStandingCourse(advanceStandingCourse) {
        var updatedAdvanceStanding = this.get('advanceStandingEditing');
      ...
      editAdvanceStandingDescription: function editAdvanceStandingDescription(advanceStandingDescription) {
        var updatedAdvanceStanding = this.get('advanceStandingEditing');
      ...
      createNewAdvanceStanding: function createNewAdvanceStanding() {
        var _this2 = this;

        var advanceStanding = this.get('store').createRecord('advancestanding', {
        ...
        // Saves the scholarship
        advanceStanding.save().then(function () {
          _this2.updateAdanceStanding();
        });
      },
      ...
      deleteAdvanceStanding: function deleteAdvanceStanding(advanceStanding) {
        // Delete from store, and will automatically do everything else like sending delete request
...
if (!runningTests) {
  require("students-records/app")["default"].create({"name":"students-records","version":"0.0.0+83414108"});
}
