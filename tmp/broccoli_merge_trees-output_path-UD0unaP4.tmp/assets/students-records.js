  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["attribute", "onchange", ["subexpr", "action", ["getStudent", ["get", "oneStudent", ["loc", [null, [15, 58], [15, 68]]], 0, 0, 0, 0]], [], ["loc", [null, [null, null], [15, 70]]], 0, 0], 0, 0, 0, 0], ["content", "oneStudent.number", ["loc", [null, [16, 27], [16, 48]]], 0, 0, 0, 0], ["content", "oneStudent.firstName", ["loc", [null, [16, 49], [16, 73]]], 0, 0, 0, 0], ["content", "oneStudent.lastName", ["loc", [null, [17, 22], [17, 45]]], 0, 0, 0, 0]],
        locals: ["oneStudent"],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "studentsModel", ["loc", [null, [10, 24], [10, 37]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [10, 16], [20, 25]]]], ["element", "action", ["loadNext"], [], ["loc", [null, [35, 29], [35, 50]]], 0, 0], ["element", "action", ["loadPrevious"], [], ["loc", [null, [38, 29], [38, 54]]], 0, 0], ["element", "action", ["exit"], [], ["loc", [null, [41, 29], [41, 46]]], 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
...
if (!runningTests) {
  require("students-records/app")["default"].create({"name":"students-records","version":"0.0.0+a840ce47"});
}
